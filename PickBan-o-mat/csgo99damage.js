...
csgo99damage.getMatch = function (matchID) {
...
csgo99damage.getOpponents = function (page, team) {
    return new Promise(function (resolve, reject) {
        request({
            url: page,
            headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:46.0) Gecko/20100101 Firefox/46.0' }
...
csgo99damage.getAllSeasons = function (teamID) {
    return new Promise(function (resolve, reject) {
        request({
...
csgo99damage.getMatchesThisSeason = function (page, team) {
    return new Promise(function (resolve, reject) {
        request({
            url: page,
            headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:46.0) Gecko/20100101 Firefox/46.0' }
...
csgo99damage.getPickBan = async function (teamID, callback) {
    var _ = require("underscore");
    ...
    for (var i in matches) {
        var data = await csgo99damage.getMatch(matches[i])
        matchdata.push(data);
    }
...
csgo99damage.getShorthand = async function (teamID) {
    return new Promise(function (resolve, reject) {
        request({
            url: 'https://csgo.99damage.de/de/leagues/teams/' + teamID,
            headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:46.0) Gecko/20100101 Firefox/46.0' }
...
csgo99damage.getLongName = async function (teamID) {
    return new Promise(function (resolve, reject) {
        request({
            url: 'https://csgo.99damage.de/de/leagues/teams/' + teamID,
            headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:46.0) Gecko/20100101 Firefox/46.0' }
